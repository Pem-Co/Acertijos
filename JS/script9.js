...
function showWin() {
 ...
 document.write('<body style="background-color: lightgreen;"><link rel="stylesheet" type="text/css" href="CSS/estilo.css"><a  style="color: red; font-family: Comic Sans MS" class="BotonStyle" href="AcertijoN10.html">Siguiente Nivel</a></body>');
}
// game loop
function loop() {
