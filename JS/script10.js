...
function showWin() {
 ...
 document.write('<body style="background-color: lightgreen;"><link rel="stylesheet" type="text/css" href="CSS/estilo.css"><a  style="color: red; font-family: Comic Sans MS" class="BotonStyle" href="Acertijo.html">Muy Bien Vamos al Nivel 1</a></body>');
}
// game loop
function loop() {
